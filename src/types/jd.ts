...
export interface JDImportResult { success: number; failed: number; errors: string[]; pendingConfirmation?: boolean; skipped?: number; replaced?: number; added?: JDDiffItem[]; removed?: JDDiffItem[]; changed?: JDDiffItem[]; }
