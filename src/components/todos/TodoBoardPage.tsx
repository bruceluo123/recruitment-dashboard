    ...
    <div className="workspace-page max-w-5xl">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">{ownerNames.a} 和 {ownerNames.b} 共用一张表，未完成事项持续保留，日期仅作提醒。</p>
        </div>
        {/* 归属筛选 */}
      ...
      {groups.length > 0 ? (
        ...
        <EmptyState icon={ListTodo} title="暂无待办" description="在上方添加一件要做的事；识别到的日期会作为提醒保留" />
      )}
