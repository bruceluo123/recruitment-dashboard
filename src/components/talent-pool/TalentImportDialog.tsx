    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-white border border-gray-200 rounded-2xl shadow-xl animate-fade-in">
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          ...
          <button onClick={onClose} className="p-1.5 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-gray-600" title={isImporting ? '收起，继续后台导入' : '关闭'}><X className="w-5 h-5" /></button>
        </div>
        ...
        <div className="p-6 space-y-4">
          {isImporting && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-400">可以关闭窗口继续其他操作，导入会在后台进行。</p>
