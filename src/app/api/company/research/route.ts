...
3. 短句、结构化。每个维度用树状要点（├──/└──）罗列，不堆资料，不写"结论："。
4. 每个维度信息下方写"信息源："，列出 1-5 条本维度真正用到的来源，格式必须是「标题 - https://原始URL」，URL 必须是真实可点击的原始链接（来自搜索结果），不要写"36氪/官网"这种只有名字没链接的来源；该维度没找到来源就写"信息源：未找到明确公开来源"。
5. 先判断公司属于什么行业，再决定每个维度去哪里补证据：科技类搜 36氪/晚点/机器之心/量子位、融资/投资方/客户案例/招聘JD/GitHub/专利；医疗搜 NMPA/CDE/临床登记；金融搜 央行/证监会/交易所；消费搜 小红书/抖音/天猫/黑猫投诉；等等。
