...
//   [8]已发offer待入职 [9]提需日期 [10]期望到岗日期 [11]优先级 [12]需求发起人 [13]简历对接人(花名&@TG)
...
export const PANEL_HEADERS = [
  ...
  '简历对接人 (花名 & @TG)', '需求发起人', '薪资范围', 'JD 岗位职责与任职要求', '加急',
];
...
function reconstructPanelVertical(text: string): string[][] | null {
  ...
  for (const ri of reqIdx) {
    ...
    rows.push([
      ...
      full[7], full[11], full[13], full[12], full[15], full[14], // 缺口/优先级/简历对接人(花名&@TG)/需求发起人/薪资范围/JD
