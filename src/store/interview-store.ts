...
const MOCK_CANDIDATES: Candidate[] = [
  { id: 'c-001', name: '张伟', resumeId: 'r-001', jdId: 'jd-001', jdTitle: '高级前端工程师', stage: 'interview', score: 88,
  ...
  { id: 'c-002', name: '李娜', resumeId: 'r-002', jdId: 'jd-006', jdTitle: '高级后端工程师', stage: 'applied', score: 82,
